...
public class PairwiseAlternatifLuasKamarActivity extends AppCompatActivity {
    ...
    public static List<Priority> listAlternatifWithWifiPriority = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pairwise_alernatif_luas_kamar);
        ...
        hargaKos1VsKos2.setText(MainActivity.listKos.get(0).getLuas_kamar());
        hargaKos1VsKos3.setText(MainActivity.listKos.get(0).getLuas_kamar());
        hargaKos1VsKos4.setText(MainActivity.listKos.get(0).getLuas_kamar());
        hargaKos2VsKos1.setText(MainActivity.listKos.get(1).getLuas_kamar());
        hargaKos2VsKos3.setText(MainActivity.listKos.get(1).getLuas_kamar());
        hargaKos2VsKos4.setText(MainActivity.listKos.get(1).getLuas_kamar());
        hargaKos3VsKos1.setText(MainActivity.listKos.get(2).getLuas_kamar());
        hargaKos3VsKos2.setText(MainActivity.listKos.get(2).getLuas_kamar());
        hargaKos3VsKos4.setText(MainActivity.listKos.get(2).getLuas_kamar());
        hargaKos4VsKos1.setText(MainActivity.listKos.get(3).getLuas_kamar());
        hargaKos4VsKos2.setText(MainActivity.listKos.get(3).getLuas_kamar());
        hargaKos4VsKos3.setText(MainActivity.listKos.get(3).getLuas_kamar());
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ahp.operate("luaskamar");
                if (ahp.checkConsistency(4)){
                    listAlternatifWithWifiPriority = ahp.getAlternatifPriorityExport();
                    if (FilterActivity.lastIndex<4){
                        switch (FilterActivity.listPriority.get(FilterActivity.lastIndex++).getNama()){
                            case "harga":
                                startActivity(new Intent(PairwiseAlternatifLuasKamarActivity.this, PairwiseAlternatifHargaActivity.class));
                                break;
                            case "wifi":
                                startActivity(new Intent(PairwiseAlternatifLuasKamarActivity.this, PairwiseAlternatifWifi.class));
                                break;
                            case "kamar mandi":
                                startActivity(new Intent(PairwiseAlternatifLuasKamarActivity.this, PairwiseAlternatifKamarMandiActivity.class));
                                break;
                        }
                    } else{
                        startActivity(new Intent(PairwiseAlternatifLuasKamarActivity.this, ResultActivity.class));
                    }

                } else{
                    Toast.makeText(PairwiseAlternatifLuasKamarActivity.this, "Jawaban tidak konsisten", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        });
