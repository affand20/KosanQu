...
public class PairwiseAlternatifWifi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pairwise_alternatif_wifi);
        ...
        hargaKos1VsKos2.setText(MainActivity.listKos.get(0).getWifi());
        hargaKos1VsKos3.setText(MainActivity.listKos.get(0).getWifi());
        hargaKos1VsKos4.setText(MainActivity.listKos.get(0).getWifi());
        hargaKos2VsKos1.setText(MainActivity.listKos.get(1).getWifi());
        hargaKos2VsKos3.setText(MainActivity.listKos.get(1).getWifi());
        hargaKos2VsKos4.setText(MainActivity.listKos.get(1).getWifi());
        hargaKos3VsKos1.setText(MainActivity.listKos.get(2).getWifi());
        hargaKos3VsKos2.setText(MainActivity.listKos.get(2).getWifi());
        hargaKos3VsKos4.setText(MainActivity.listKos.get(2).getWifi());
        hargaKos4VsKos1.setText(MainActivity.listKos.get(3).getWifi());
        hargaKos4VsKos2.setText(MainActivity.listKos.get(3).getWifi());
        hargaKos4VsKos3.setText(MainActivity.listKos.get(3).getWifi());
                ...
                if (ahp.checkConsistency(4)){
                    ...
                    if (FilterActivity.lastIndex<4){
                        switch (FilterActivity.listPriority.get(FilterActivity.lastIndex++).getNama()){
                            case "harga":
                                startActivity(new Intent(PairwiseAlternatifWifi.this, PairwiseAlternatifHargaActivity.class));
                                break;
                            case "luas kamar":
                                startActivity(new Intent(PairwiseAlternatifWifi.this, PairwiseAlternatifLuasKamarActivity.class));
                                break;
                            case "kamar mandi":
                                startActivity(new Intent(PairwiseAlternatifWifi.this, PairwiseAlternatifKamarMandiActivity.class));
                                break;
                        }
                    } else{
                        startActivity(new Intent(PairwiseAlternatifWifi.this, ResultActivity.class));
                    }

                } else {
                    Toast.makeText(PairwiseAlternatifWifi.this, "Jawaban tidak konsisten", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        });
