...
public class PairwiseAlternatifHargaActivity extends AppCompatActivity {
    ...
    public static List<Priority> listAlternatifWithHargaPriority = new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pairwise_alternatif_harga);
        ...
        hargaKos1VsKos2.setText(MainActivity.listKos.get(0).getHarga());
        hargaKos1VsKos3.setText(MainActivity.listKos.get(0).getHarga());
        hargaKos1VsKos4.setText(MainActivity.listKos.get(0).getHarga());
        hargaKos2VsKos1.setText(MainActivity.listKos.get(1).getHarga());
        hargaKos2VsKos3.setText(MainActivity.listKos.get(1).getHarga());
        hargaKos2VsKos4.setText(MainActivity.listKos.get(1).getHarga());
        hargaKos3VsKos1.setText(MainActivity.listKos.get(2).getHarga());
        hargaKos3VsKos2.setText(MainActivity.listKos.get(2).getHarga());
        hargaKos3VsKos4.setText(MainActivity.listKos.get(2).getHarga());
        hargaKos4VsKos1.setText(MainActivity.listKos.get(3).getHarga());
        hargaKos4VsKos2.setText(MainActivity.listKos.get(3).getHarga());
        hargaKos4VsKos3.setText(MainActivity.listKos.get(3).getHarga());
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ahp.checkConsistency(4)){
                    listAlternatifWithHargaPriority = ahp.getAlternatifPriorityExport();
                    if (FilterActivity.lastIndex<4){
                        switch (FilterActivity.listPriority.get(FilterActivity.lastIndex++).getNama()){
                            case "wifi":
                                startActivity(new Intent(PairwiseAlternatifHargaActivity.this, PairwiseAlternatifWifi.class));
                                break;
                            case "luas kamar":
                                startActivity(new Intent(PairwiseAlternatifHargaActivity.this, PairwiseAlternatifLuasKamarActivity.class));
                                break;
                            case "kamar mandi":
                                startActivity(new Intent(PairwiseAlternatifHargaActivity.this, PairwiseAlternatifKamarMandiActivity.class));
                                break;
                        }
                    } else{
                        startActivity(new Intent(PairwiseAlternatifHargaActivity.this, ResultActivity.class));
                    }

                } else{
                    Toast.makeText(PairwiseAlternatifHargaActivity.this, "Jawaban tidak konsisten", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
        });
